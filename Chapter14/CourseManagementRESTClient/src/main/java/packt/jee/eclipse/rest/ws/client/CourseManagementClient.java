...
public class CourseManagementClient {
	...
	public static void testGetCoursesJSON() {
		...
		// Note that java.util.Base64 is available from JDK 1.8 onwards.
		// If you are using version below 1.8, then you can use org.apache.commons.codec.binary.Base64
